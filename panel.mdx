...
### 2. **Modern UI Design**  
<img  
  src="https://nebula.style/"  
  alt="Modern UI"  
  className="rounded-md shadow-md"  
/>  
We use the **Nebula Theme** which provides a professional and clean look, making navigation easy even for new users.  
For more details, visit [Nebula](https://nebula.style).
